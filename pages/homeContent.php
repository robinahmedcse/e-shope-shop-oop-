            ...
            <div class="container">
                <div class="row">
                   ...
                   <!--/end of col-sm- 3 --> 
                    ...
                    <?php
                    $run_query_select_recent_published_product = $object_apllication->select_all_recent_published_product();
                    ?>
                    <div class="col-sm-9 padding-right">
                        ...
                        <div class="features_items"><!--features_items-->
                            ...
                            <?php
                            while ($select_recent_published_product = mysqli_fetch_assoc($run_query_select_recent_published_product)) {
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="admin/<?php echo $select_recent_published_product['product_image']; ?>" alt="" />
                                                <h2><?php echo $select_recent_published_product['product_price']; ?>BDT</h2>
                                                <p><?php echo $select_recent_published_product['product_name']; ?></p>
                                            ...
                                            <div class="product-overlay">
                                                <div class="overlay-content">
                                                    <h2><?php echo $select_recent_published_product['product_price']; ?>BDT</h2>
                                                    <p><?php echo $select_recent_published_product['product_name']; ?></p>
                                                    <a href="product-details.php?id=<?php echo $select_recent_published_product['product_id']; ?>" class="btn btn-default add-to-cart">Product Details</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="choose">
